...
export const PropertyVerificationModal: React.FC<
  PropertyVerificationModalProps
> = ({ property, isOpen, onClose, onConfirm }) => {
      ...
      >
        ...
        <div className="ls-modal-body space-y-4">
          <p className="text-sm text-text-muted dark:text-text-darkMuted">
            ...
            . This action requires a reason, which will be logged and may be
            shown to the property owner.
          </p>
